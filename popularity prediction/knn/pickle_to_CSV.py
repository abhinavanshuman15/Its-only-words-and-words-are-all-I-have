...
sample_song_dataset = pickle.load(open(genre_name+'song_vectors_dataset_'+did+'.pickle','rb'))
p = open(genre_name+'train_'+did+'.txt', 'w')
q = open(genre_name+'test_'+did+'.txt', 'w')
