...
dataset 	 = pickle.load(open("../dataset/80_20_train_"+did+".pickle" , "rb"))
dataset_test = pickle.load(open("../dataset/80_20_test_"+did+".pickle" , "rb"))

trackId_2_intId = pickle.load(open("../trackId_2_intId.pickle" , "rb"))

model = gensim.models.doc2vec.Doc2Vec.load('../models/model_80_20_'+did+'_dbow.model')
...
pickle.dump(id_detail, open('id_detail_'+did+'.pickle','wb'))
logger.info("Done")
